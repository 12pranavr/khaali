...
test suite fires 20 simultaneous requests at one berth and asserts exactly one
winner.
...
| `GET /api/live` | simulated position of all 6 trains |
...
19 tests: routing against `corridor_all_pairs.xlsx` (157 served pairs and 25
no-service pairs), interval maths, packing optimality, locking, payment
idempotency, a 50-phone race, and expiry.
